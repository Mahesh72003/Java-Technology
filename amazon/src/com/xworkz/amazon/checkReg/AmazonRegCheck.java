...
public class AmazonRegCheck {
    ...
    public void getUserDetails(AmazonDto amazonDto) {
        System.out.println("the User Name is " + this.amazonDto.getName());
        System.out.println("the Email Id is " + this.amazonDto.getEmailAddress());
        System.out.println("the Phone no is " + this.amazonDto.getPhoneNo());
        System.out.println("the password is " + this.amazonDto.getPassword());
        System.out.println("the gender is " + this.amazonDto.getGender());
        System.out.println("the Dob is " + this.amazonDto.getDob());
        System.out.println("the location is " + this.amazonDto.getLocation());
        System.out.println("the address is " + this.amazonDto.getAddress());
        System.out.println("the mode of payment is " + this.amazonDto.getPaymentMethod());
    }
}
