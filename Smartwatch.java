class Smartwatch 
{
    ...
    {
        System.out.println("Redmi Watch 5 Active, 2\" Display, Metal Body, 18 Day Battery, Bluetooth Calling, Advanced AI Noise Cancellation, Alexa, Silver");
