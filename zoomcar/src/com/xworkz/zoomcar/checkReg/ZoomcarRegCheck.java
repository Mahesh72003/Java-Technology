...
ZoomcarDto zoomcarDto;
    ...
    public void displayUserDetails(ZoomcarDto user) {

        System.out.println("First Name: " + this.zoomcarDto.getFirstName());
        System.out.println("Last Name: " + this.zoomcarDto.getLastName());
        System.out.println("Email Address: " + this.zoomcarDto.getEmailAddress());
        System.out.println("Phone Number: " + this.zoomcarDto.getPhoneNo());
        System.out.println("Gender: " + this.zoomcarDto.getGender());
        System.out.println("Date of Birth: " + this.zoomcarDto.getDob());
        System.out.println("Location: " + this.zoomcarDto.getLocation());
        System.out.println("Address: " + this.zoomcarDto.getAddress());
        System.out.println("Driving License Number: " + this.zoomcarDto.getDrivingLicenseNumber());
        System.out.println("License Expiry Date: " + this.zoomcarDto.getLicenseExpiryDate());
        System.out.println("Payment Method: " + this.zoomcarDto.getPaymentMethod());
    }
}
