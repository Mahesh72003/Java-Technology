...
public class Zepto
{
    ...
    public void displayUserDetails(ZeptoUserDto user) {

        System.out.println("Name: " + zeptoUserDto.getName());
        System.out.println("Email: " + zeptoUserDto.getEmail());
        System.out.println("Phone Number: " + zeptoUserDto.getPhoneNumber());
        System.out.println("Address: " + zeptoUserDto.getAddress());
    }
}
